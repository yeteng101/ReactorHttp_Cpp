...
{
    // Clear both old registrations first. Channel already contains the new
    // event mask when modify() is called, so checking it here can leave a
    // stale write registration behind.
